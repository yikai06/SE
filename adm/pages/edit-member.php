...
if ($type == "del") {
    ...
    <script>
        ...
        if (confirmDelete) {
            // Send an AJAX request to the server to delete the member
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "edit-member.php?id=<?= $page ?>&email=<?= $row['email'] ?>", true);
            xhr.onload = function () {
                if (xhr.status == 200) {
                    alert("Member deleted successfully!");
                } else {
                    alert("An error occurred. Member not deleted.");
                }
                                ...
                                while ($row_page = $sql_plan->fetch_array(MYSQLI_ASSOC)) {
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" value="<?= $row_page['username']; ?>"
                                                placeholder="Username" class="form-control" name="name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Email</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" placeholder="name@example.com"
                                                value="<?= $row_page['email']; ?>" class="form-control" name="email">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <div class="input-group mb-3"><span class="input-group-prepend"><span
                                                ...
                                                <input type="text" placeholder="Phone number" value="<?= $row_page['phone']; ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" value="<?= $row_page['fullname']; ?>"
                                                placeholder="First Name" class="form-control" name="fname">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Last Name</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" value="<?= $row_page['lastname']; ?>"
                                                placeholder="Last Name" class="form-control" name="lname">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Age</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" placeholder="age" value="<?= $row_page['age']; ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="payment_method" value="male" <?php echo ($row_page['gender'] == "male") ? 'checked' : ''; ?>
                                                    class="custom-control-input"><span class="custom-control-label">Male</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="payment_method" value="female" <?php echo ($row_page['gender'] == "female") ? 'checked' : ''; ?>
