<?php
    ...
    $sql = "SELECT * FROM $member WHERE trash != '1' ";
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-member.php?id='.$row_page['id'].'"><i class="fas fa-edit"></i></a>
                                                    <a href="edit-member.php?type=del&id='.$row_page['id'].'"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            ';
                                            }
